export { address, activity, activityPurpose, answer, answerItem, answerPassword,
  appointment, department, dr, due, facility, facilityContact, inquiry,response,
  ...
  webMaster, webNotice, webReservation, classification, log, base
